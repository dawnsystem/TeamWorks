...
export default function BoardColumn({ sectionId, title, tasks, projectId }: BoardColumnProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent hover:scrollbar-thumb-gray-400 dark:hover:scrollbar-thumb-gray-500" style={{ minHeight: 0 }}>
        <SortableContext
